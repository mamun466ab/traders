@extends('placeholder')
@section('title', 'Others Cost Sell')
@section('content')

<section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> Others Cost Sell</h3>
    <hr />
    ...
    <div class="row mt">
        <div class="col-lg-8 col-lg-offset-2">
            <div class="form-panel">
                ...
                {!! Form::open(['url' => '/others-cost-sell', 'class' => 'form-horizontal style-form', 'method' => 'post', 'id' => 'wbd_form']) !!}
