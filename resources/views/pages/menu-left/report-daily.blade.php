@extends('placeholder')
@section('title', 'Product Buy Report')
@section('content')

<section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> Product Buy Report</h3>
    <hr />
    <div class="container-fluid">
    {!! Form::open(['url' => '/product-report', 'class' => 'style-form', 'method' => 'post', 'id' => 'gwbd_form']) !!}
    <div class="col-md-8">
    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="content-panel">
                <h4><i class="fa fa-angle-right"></i>Product Buy Report<span class="pull-right" style="padding-right: 5px;">Date : {{$date }}</span></h4>
                <section id="unseen">
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr style="font-weight: bold;">
                                ...
                                <td align='right'>{{number_format($totalPrc->ttlprc,2)}} Tk.</td>
                                <td colspan="3"></td>
                            </tr>
                        </tbody>
                    </table>
