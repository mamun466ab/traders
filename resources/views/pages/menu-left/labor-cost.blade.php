...
<section class="wrapper">
    <h3><i class="fa fa-angle-right"></i> Labor Cost</h3>
    <hr />
    ...
    <div class="row mt">
        <div class="col-lg-8 col-lg-offset-2">
            <div class="form-panel">
                ...
                {!! Form::open(['url' => '/labor-cost', 'class' => 'form-horizontal style-form', 'method' => 'post', 'id' => 'wbd_form']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="datepicker" type="text" id="datepicker" class="form-control" placeholder="Cost Date" onkeydown="return false">
                    </div>
                </div>
